...
public class CommonProxy
{
	...
	public void init()
	{
		...
		EntityRegistry.registerModEntity(EntityGrizzlyBear.class, "grizzlybear",
				1, BearWithMe.instance, 80, 3, true,
				new Color(255, 255, 255).getRGB(),
				new Color(119, 84, 57).getRGB());
		EntityRegistry.addSpawn(EntityGrizzlyBear.class, 1, 1, 1,
				EnumCreatureType.MONSTER, gList.toArray(new Biome[0]));

		Collection<Biome> bList = new ArrayList<>();
		Collections.addAll(bList,
		...
		EntityRegistry.registerModEntity(EntityBlackBear.class, "blackbear", 2,
				BearWithMe.instance, 80, 3, true,
				new Color(255, 255, 255).getRGB(), new Color(0, 0, 0).getRGB());
		EntityRegistry.addSpawn(EntityBlackBear.class, 1, 1, 1,
				EnumCreatureType.MONSTER, bList.toArray(new Biome[0]));
		...
		EntityRegistry.registerModEntity(EntityPandaBear.class, "pandabear", 3,
				BearWithMe.instance, 80, 3, true,
				new Color(255, 255, 255).getRGB(), new Color(0, 0, 0).getRGB());
		EntityRegistry.addSpawn(EntityPandaBear.class, 1, 1, 1,
				EnumCreatureType.CREATURE, pList.toArray(new Biome[0]));
